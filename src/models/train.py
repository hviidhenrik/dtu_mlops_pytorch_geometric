...
def get_train_args():
    ...
    parser.add_argument('--cloud-dir', default=None, type=str, help='Google Cloud bucket for storing trained models')
...
def main():
    ...
    if args.cloud_dir:
        ...
        best_model_file = os.path.join(args.save_dir, model_filename)
        subprocess.check_call([
            'gsutil', 'cp', best_model_file,
            os.path.join(args.cloud_dir, model_filename)])
